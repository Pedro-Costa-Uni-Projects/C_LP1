...
void printRestaurant(tableContent queue[MAX], int currentHour, int endQ,
                     int startQ, tableContent tables[4]);
void initializeTables(tableContent tables[4]);
int maintenance(int currentHour, tableContent tables[4], int endQ, int startQ,
                tableContent queue[MAX]);
int checkForTable(tableContent tables[4]);
void sitPeople(tableContent tables[4], int people, int hours,
               int availableTable);
